...
import A_AdminHomePage from "./components/A_AdminHomePage";
import A_ManageCategories from "./components/A_ManageCategories";
...
const router = createBrowserRouter([
  ...
  { path: "/HostGameStats", element: <H_GameStats /> },
  { path: "/HostLeaderboard", element: <H_Leaderboard /> },
  ...
  { path: "/AdminHomePage", element: <A_AdminHomePage /> },
  { path: "/ManageCategories", element: <A_ManageCategories /> },
]);
